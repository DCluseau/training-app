...
export const routes: Routes = [
  ...
  {path : 'customers', component : CustomerComponent}, // Affiche le composant CustomerComponent lorsque l'URL est /customer
  {path : 'users', component : UserComponent}, // Affiche le composant UserComponent lorsque l'URL est /user
